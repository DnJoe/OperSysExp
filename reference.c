...
void fcfs(int n, plist * pro1)      //先来先到
{
	void show(int n, plist * process);
...
void sjf(int n, plist * pro1)// 短进程优先
{
	void show(int n, plist * process);
	int i, j, k;
	int m = 0;
...
void rr(int n, plist * pro1)// 时间片轮转
{
	void show(int n, plist * process);
...
void hrrn(int n, plist * pro1)// 高响应比优先
{
...
int cal(int a, plist * pro2)//  计算响应比
{
	int pr;
